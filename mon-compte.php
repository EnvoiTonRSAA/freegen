                        ...
                        <div class="col-sm-8">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <img src="<?=get_badge($utilisateur['id']) ?>" style="width:25;height:25px">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="ip_connexion">Adresse IP lors de votre dernière connexion</label>
                        <input type="text" id="ip_connexion" class="form-control" value="<?=$utilisateur['ip_connexion'] ?>" readonly/>
                    </div>
                    <div class="form-group">
            ...
            <div class="card text-white bg-info overflow-hidden">
                <div class="card-body">
                    <div class="toll-free-box text-center">
                        <h4> <i class="mdi mdi-help"></i> Une question ? Rejoignez le <a href="https://discord.gg/LightGen">Discord</a></h4>
                    </div>
                </div>
            </div>
        </div>                     
