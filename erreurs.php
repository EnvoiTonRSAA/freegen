...
<html lang="fr">
    <head>
        ...
        <meta name="title" content="LightGen.xyz - Premier Générateur de France">
        <meta name="description" content="LightGen vous permet de générer des comptes premium sur une vaste gamme de services, y compris les films, la télévision, les sports, le contenu pour adultes, les jeux vidéo et bien plus encore et cela 100% Gratuitement en 2 clics !"/>
        ...
        <meta property="og:title" content="LightGen.xyz - Premier Générateur de France"/>
        <meta property="og:description" content="LightGen vous permet de générer des comptes premium sur une vaste gamme de services, y compris les films, la télévision, les sports, le contenu pour adultes, les jeux vidéo et bien plus encore et cela 100% Gratuitement en 2 clics !">
        ...
        <meta property="twitter:title" content="LightGen.xyz - Premier Générateur de France"/>
        <meta property="twitter:description" content="LightGen vous permet de générer des comptes premium sur une vaste gamme de services, y compris les films, la télévision, les sports, le contenu pour adultes, les jeux vidéo et bien plus encore et cela 100% Gratuitement en 2 clics !">
    ...
    <body class="loading authentication-bg" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":true, "showRightSidebarOnStart": true}'>
                    ...
                    <div class="col-lg-5">
                        <div class="card">
                            <div class="card-header pt-4 pb-4 text-center bg-primary">
                                <a href="/">
                                    <span><img src="https://lightgen.xyz/assets/images/logo.png" alt="Logo" height="55"></span>
                                </a>
                            </div>
        ...
        <footer class="footer footer-alt">
            © 2016 - <?=date('Y') ?> LightGen. Tous droits réservés.
        </footer>
