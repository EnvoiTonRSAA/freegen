...
<div class="card cta-box bg-primary text-white">
    <div class="card-body">
        <div class="text-center">
            <h3 class="m-0 font-weight-normal cta-box-title">Déjà inscrit sur <b>l'ancienne version ?</b></h3>
            <br>
            <a href="/migration" class="btn btn-sm btn-light btn-rounded">Migrez votre compte <i class="mdi mdi-arrow-right"></i></a>
        </div>
    </div>
</div>
<?php } ?>
