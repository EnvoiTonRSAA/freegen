...
<body>
    <div class="page">
        <div class="header">
            <img src="https://i.imgur.com/ULyFhtk.jpeg" style="height:40px"/>
        </div>
        <div class="content" style="text-align:center">
            ...
            <?php } else if ($_GET['erreur'] == 500) { ?>
                ...
                (si dans 20min c'est toujours comme ça, passez nous dire bonjour sur <a href="https://discord.gg/lightgen" class="text-muted"><b>Discord</b></a></p>

            <?php } ?>
                <a class='btn-retour' href="https://lightgen.fr"></a>
        </div>
        <div class="footer">
